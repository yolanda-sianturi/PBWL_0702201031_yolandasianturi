...
<head>
	...
	<title>E-lektronik | Pembayaran Token Listrik</title>

	<link rel="shortcut icon" href="<?php echo AST; ?>/img/rumah1.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/pln2.png" class="brand">
